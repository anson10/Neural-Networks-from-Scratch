...
class Activation_ReLU:
    def forward(self, inputs, training):
        if inputs is None:
            raise ValueError("Recieved None as input")
        self.inputs = inputs
...
class Model:
    ...
    # Initialize accuracy object
        ...
        if validation_data is not None:
            validation_steps = 1  # Initialize validation_steps for later use
    ...
    #Load the weigths and updates a model instance with them
    ...
    def save(self, path):
        ...
        # Remove data and gradient from the input
...
# Finalize the model
model.finalize()
model.save('saved_models/fashion_mnist.model')
...
# model.load('saved_models/fashion_mnist.model')
...
image_data = 255 - image_data # invert colors
